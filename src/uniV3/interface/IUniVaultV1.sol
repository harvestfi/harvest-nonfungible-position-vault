...
import "../submodules/interface/IUniVaultSubmoduleRewardV1LiquidateOnly.sol";

interface IUniVaultV1 is IUniVaultSubmoduleDepositV1, IUniVaultSubmoduleRewardV1LiquidateOnly, IERC20Upgradeable {
