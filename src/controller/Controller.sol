...
contract Controller is Governable {
    ...
    function setProfitSharingNumerator(uint256 _profitSharingNumerator) public onlyGovernance {
        require(_profitSharingNumerator + strategistFeeNumerator + platformFeeNumerator <= MAX_TOTAL_FEE, "total fee too high");
    ...
    function confirmSetProfitSharingNumerator() public onlyGovernance {
        ...
        require(nextProfitSharingNumerator + strategistFeeNumerator + platformFeeNumerator <= MAX_TOTAL_FEE, "total fee too high");
    ...
    function setStrategistFeeNumerator(uint256 _strategistFeeNumerator) public onlyGovernance {
        require(_strategistFeeNumerator + platformFeeNumerator + profitSharingNumerator <= MAX_TOTAL_FEE, "total fee too high");
    ...
    function confirmSetStrategistFeeNumerator() public onlyGovernance {
        ...
        require(nextStrategistFeeNumerator + platformFeeNumerator + profitSharingNumerator <= MAX_TOTAL_FEE, "total fee too high");
    ...
    function setPlatformFeeNumerator(uint256 _platformFeeNumerator) public onlyGovernance {
        require(_platformFeeNumerator + strategistFeeNumerator + profitSharingNumerator <= MAX_TOTAL_FEE, "total fee too high");
    ...
    function confirmSetPlatformFeeNumerator() public onlyGovernance {
        ...
        require(nextPlatformFeeNumerator + strategistFeeNumerator + profitSharingNumerator <= MAX_TOTAL_FEE, "total fee too high");
