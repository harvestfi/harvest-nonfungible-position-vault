...
import "./interface/IUniVaultSubmoduleDepositV1.sol";

contract UniVaultSubmoduleDepositV1 is
    ERC20Upgradeable,
    ...
    IUniVaultSubmoduleDepositV1
{
    ...
    function migrateToNftFromV2(
        ...
        uint256 _tolerance
    ) public virtual override checkSqrtPriceX96(_sqrtRatioX96, _tolerance) returns (uint256, uint256) {
