...
contract ZapDebug {
        ...
        returns (uint256, uint256)
    {
        ...
        console.log("in function swap.      ");
        console.log("amountOutMinimum:      ", amountOut);
        console.log("tokenOutAmountBefore:  ", IERC20Upgradeable(tokenOut).balanceOf(address(this)));
        ...
        console.log("tokenOutAmountAfter:   ", IERC20Upgradeable(tokenOut).balanceOf(address(this)));
